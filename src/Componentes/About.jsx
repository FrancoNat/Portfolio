      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            ...
            <span>  Full Stack con experiencia</span> en la creación de aplicaciones web completas.
          </h1>
          ...
          <div className="flex justify-center">
            <div className="text-center"> {/* Envuelve el botón en un contenedor con la clase "text-center" */}
              <a
                href="#contact"
                className="inline-flex items-center justify-center text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg"
              >
                Contáctame
              </a>
            </div>
            <a
              href="#projects"
              className="ml-4 inline-flex items-center justify-center text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"
              style={{ width: "146.29px" }} // Establece el ancho del botón en 146.29px
            >
              <span className="flex items-center justify-center h-full">Proyectos</span>
            </a>
          </div>
        </div>
